...
output_suffix = "_looped_current_CO2off" # must include "_" at the beginning
# Location to place the outputs of this script
outdir = "~/RDM/projects/climate_forecasts/outputs/looped_current/"
#outdir_drivers <- "/exports/csce/datastore/geos/groups/gcel/for_tim/future_climate_drivers/check/" #TG
...
#      wind_spd_bias = wind_spd_bias + wind_spd_ms
      ...
      new_drivers$met[start:finish,5]  = rep(c(drivers$met[(dim(drivers$met)[1]-11):dim(drivers$met)[1],5]),nos_years_anomaly) 
