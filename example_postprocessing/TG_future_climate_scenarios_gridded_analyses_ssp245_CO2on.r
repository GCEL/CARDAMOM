...
infofile = paste(load_paths$cardamom_outputs,"/DALEC.A1.C1.D2.F2.H2.P1.#_MHMCMC/Fin_strat_mineral_01degree_SSedcyes_LL_EFDA_harvestx2_maxroot_kallio/infofile.RData",sep="")
# Load project for climate
load(infofile)

# Suffix for the output files
output_suffix = "_def_baseHARV_CO2on" # must include "_" at the beginning
# Location to place the outputs of this script
outdir = "/exports/csce/datastore/geos/groups/gcel/for_tim/future_climate_outputs/"
...
ssp_scenarios = "ssp245" #c("ssp119","ssp126","ssp434","ssp245","ssp370","ssp585")
