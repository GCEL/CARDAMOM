...
output_suffix = "_looped_current_CO2on" # must include "_" at the beginning
...
#      wind_spd_bias = wind_spd_bias + wind_spd_ms
      ...
      new_drivers$met[start:finish,5]  = co2_bias # loops the last year of the contemporary CO2 TG # co2_bias = CO2 on
