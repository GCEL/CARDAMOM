...
infofile = paste(load_paths$cardamom_outputs,"/DALEC.A1.C1.D2.F2.H2.P1.#_MHMCMC/Fin_BIGpixel_GRIDforward_FINAL/infofile.RData",sep="")
# Load project for climate
load(infofile)

# Suffix for the output files
output_suffix = "_BIGpix_intenseHARV_CO2off" # must include "_" at the beginning
