...
! This file contains the source code of DALEC.A1.C2.D2.F2.H2.P3.R1.009
!
...
module CARBON_MODEL_MOD
  ...
  subroutine CARBON_MODEL(start,finish,met,pars,deltat,nodays,lat,FLUXES,POOLS,DIAGS &
    ...
    ! Evergreen Analytical - ACMv2 - BUCKET (DALEC.A1.C2.D2.F2.H2.P3.R1.009) model.
    ...
    ! 55 = growth respiration from labile->foliage transfer (gC/m2/day)
    ...
    ! p(2)  = fraction of GPP as maintenance respiration (fraction)
      ...
      type(model_working_variables) :: mV
       ...
       if (gsi_gradient > leaf_phenology_threshold .and. gsi(step) > vsmall .and. available_labile > 0d0) then
           ...
           if (alloc_leaf_fraction > 0d0) then
               ...
               alloc_leaf_gCm2day = available_labile * (1d0-(1d0-alloc_leaf_fraction)**time) !different to model 008
