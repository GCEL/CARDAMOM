...
! of DALEC.A2.C1.D2.F2.H2.P1.020 as a function of observations and ecological dynamical constraints.
!
...
!    end do
    ...
    do fl = 1, nofluxes
       ! fl=41 (transpiration) is overwritten below with a flux-weighted calculation; skip here
       if (fl == 41) cycle
