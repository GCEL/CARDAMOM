...
!endif
     ...
     out_var1(i,1:nodays,6)  = FLUXES(1:nodays,29)      ! Total harvested material (gC/m2/day)
     ...
     out_var1(i,1:nodays,12) = FLUXES(1:nodays,10)      ! foliage to litter (gC/m2/day)
     out_var1(i,1:nodays,13) = FLUXES(1:nodays,12)      ! fine root to litter (gC/m2/day)
     out_var1(i,1:nodays,14) = FLUXES(1:nodays,11)      ! wood to som (gC /m2/day)
     out_var1(i,1:nodays,15) = FLUXES(1:nodays,15)      ! litter to som (gC/m2/day)
     ! C disturbance fluxes (gC/m2/day)
     out_var1(i,1:nodays,16) = null ! FLUXES(1:nodays,18)      ! fire emission from labile (gC/m2/day)
     out_var1(i,1:nodays,17) = null ! FLUXES(1:nodays,24)      ! fire induced litter from labile (gC/m2/day)
     out_var1(i,1:nodays,18) = null ! FLUXES(1:nodays,19)      ! fire emission from foliage (gC/m2/day)
     out_var1(i,1:nodays,19) = null ! FLUXES(1:nodays,25)      ! fire induced litter from foliage (gC/m2/day)
     out_var1(i,1:nodays,20) = null ! FLUXES(1:nodays,20)      ! fire emission from fine roots (gC/m2/day)
     out_var1(i,1:nodays,21) = null ! FLUXES(1:nodays,26)      ! fire induced litter from fine roots (gC/m2/day)
     out_var1(i,1:nodays,22) = null ! FLUXES(1:nodays,21)      ! fire emission from wood (gC/m2/day)
     out_var1(i,1:nodays,23) = null ! FLUXES(1:nodays,27)      ! fire induced litter from wood (gC/m2/day)
     out_var1(i,1:nodays,24) = null ! FLUXES(1:nodays,22)      ! fire emission from litter (gC/m2/day)
     out_var1(i,1:nodays,25) = null ! FLUXES(1:nodays,28)      ! fire induced litter from litter (gC/m2/day)
     out_var1(i,1:nodays,26) = null ! FLUXES(1:nodays,23)      ! fire emission from som (gC/m2/day)
     out_var1(i,1:nodays,27) = null ! FLUXES(1:nodays,30)      ! harvest extracted from labile (gC/m2/day)
     out_var1(i,1:nodays,28) = null ! FLUXES(1:nodays,31)      ! harvest extracted from foliage (gC/m2/day)
     out_var1(i,1:nodays,29) = null ! FLUXES(1:nodays,32)      ! harvest extracted from fine roots (gC/m2/day)
     out_var1(i,1:nodays,30) = null ! FLUXES(1:nodays,33)      ! harvest extracted from wood (gC/m2/day)
     out_var1(i,1:nodays,31) = null ! FLUXES(1:nodays,34)      ! harvest extracted from litter (gC/m2/day)
     out_var1(i,1:nodays,32) = null ! FLUXES(1:nodays,35)      ! harvest extracted from som (gC/m2/day)
     out_var1(i,1:nodays,33) = null ! FLUXES(1:nodays,36)      ! harvest litter / residue from labile (gC/m2/day)
     out_var1(i,1:nodays,34) = null ! FLUXES(1:nodays,37)      ! harvest litter / residue from foliage (gC/m2/day)
     out_var1(i,1:nodays,35) = null ! FLUXES(1:nodays,38)      ! harvest litter / residue from fine roots (gC/m2/day)
     out_var1(i,1:nodays,36) = null ! FLUXES(1:nodays,39)      ! harvest litter / residue from wood (gC/m2/day)
     ! C pools (gC/m2)
     ...
     out_var1(i,1:nodays,43) = lai                      ! LAI (m2/m2)
     ! Photosynthesis / C~water coupling related
     out_var1(i,1:nodays,44) = cica_time                ! ratio of leaf internal to external CO2

     out_var1(i,1:nodays,45) = FLUXES(1:nodays,19)      ! animal manure C soil input (per time step)
     out_var1(i,1:nodays,46) = FLUXES(1:nodays,20)      ! animal resp co2 (per time step)
     out_var1(i,1:nodays,47) = FLUXES(1:nodays,21)      ! animal ch4 (per time step)
     ...
     out_var2(i,1) = sum( ((FLUXES(1:nodays,8) + & ! Natural losses
                            FLUXES(1:nodays,18) + FLUXES(1:nodays,24) + & ! Fire losses
                            FLUXES(1:nodays,30) + FLUXES(1:nodays,36) + & ! Harvest losses
                            FLUXES(1:nodays,22))                        & ! Cutting/grazing losses
     ...
     ! Soil
     out_var2(i,6) = sum( ((FLUXES(1:nodays,14) + FLUXES(1:nodays,23) + FLUXES(1:nodays,35)) &
     ...
     out_var3(i,5) = sum(FLUXES(:,10)+FLUXES(:,12)+ &
                         ...
                         FLUXES(:,36)+FLUXES(:,37)+FLUXES(:,38)) ! litter (foliage + roots)
     ...
     out_var3(i,6) = sum(FLUXES(:,15)+FLUXES(:,27)+FLUXES(:,28)+FLUXES(:,39)) ! som
