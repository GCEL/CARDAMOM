...
! Subroutine to allow direct interface between DALEC.A4.C6.D2.F2.H3.P10.026 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec26(output_dim,MTT_dim,SS_dim &
                   ,met,pars &
...
!endif
     ...
     out_var1(i,1:nodays,83) = DIAGS(1:nodays,30)          ! Number of live foliage cohorts
     out_var1(i,1:nodays,84) = DIAGS(1:nodays,31)          ! Canopy level relative NUE (0-1)
     ...
     out_var3(i,1) = sum(FLUXES(:,5)+FLUXES(:,52)) ! Labile
