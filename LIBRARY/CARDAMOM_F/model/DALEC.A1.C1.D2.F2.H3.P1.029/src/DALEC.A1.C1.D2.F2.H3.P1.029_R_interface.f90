...
! Subroutine to allow direct interface between DALEC.A1.C1.D2.F2.H3.P1 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec29(output_dim,MTT_dim,SS_dim &
                  ,met,pars &
  ...
  use carbon_model_memory, only: wSWP_time, LWP_time &
...
!endif
     ...
     out_var1(i,1:nodays,63) = LWP_time(1:nodays)          ! mean LWP (MPa)
