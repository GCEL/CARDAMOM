...
!endif
     ...
     out_var1(i,1:nodays,63) = DIAGS(1:nodays,13)          ! day time mean canopy temperature (oC)
     out_var1(i,1:nodays,64) = DIAGS(1:nodays,14)          ! day time mean soil temperature (oC)
