...
! Subroutine to allow direct interface between DALEC.A1.C1.D2.F2.H2.P2.018 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec18(output_dim,MTT_dim,SS_dim &
                   ,met,pars &
...
!endif
     ...
     out_var1(i,1:nodays,66) = DIAGS(1:nodays,16)          ! Density-dependent wood turnover (fraction/day)
