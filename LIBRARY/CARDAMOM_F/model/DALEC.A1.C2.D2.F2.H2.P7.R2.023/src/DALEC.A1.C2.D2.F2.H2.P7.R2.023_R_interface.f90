...
! Subroutine to allow direct interface between DALEC.A1.C2.D2.F2.H2.P4.R2 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec23(output_dim,MTT_dim,SS_dim &
                   ,met,pars &
...
!endif
     ...
     out_var1(i,1:nodays,59) = POOLS(1:nodays,8)        ! Surface water (0-30cm, mm or kgH2O/m2)
     ...
     ! Canopy phenology
     out_var1(i,1:nodays,72) = DIAGS(1:nodays,16)       ! Canopy CGI (0-1)
     out_var1(i,1:nodays,73) = DIAGS(1:nodays,17)       ! Canopy CGI gradient (-1->1)
     out_var1(i,1:nodays,74) = DIAGS(1:nodays,18)       ! leafT_limiter (0-1)
     out_var1(i,1:nodays,75) = DIAGS(1:nodays,19)       ! leafW_limiter (0-1)
     out_var1(i,1:nodays,76) = DIAGS(1:nodays,20)       ! NCCE gradient
     out_var1(i,1:nodays,77) = DIAGS(1:nodays,21)       ! NCCE return on leaf investment (gC/gC/m2/day)
     out_var1(i,1:nodays,78) = DIAGS(1:nodays,22) &     ! NCCE (gC/gCleaf/m2/day -> gC/m2/day)     
                             * POOLS(1:nodays,2)        
     out_var1(i,1:nodays,79) = DIAGS(1:nodays,23)       ! CMI (0-1) 
