...
! Subroutine to allow direct interface between DALEC.A1.C2.D2.F2.H1.P3.R1.008 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec8(output_dim,MTT_dim,SS_dim &
                  ,met,pars &
...
!endif
     ...
     out_var1(i,1:nodays,59) = -9999d0                  ! Surface water not output as held at field capacity
