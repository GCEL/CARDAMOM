...
! Subroutine to allow direct interface between DALEC.A2.C1.D2.F2.H2.P1 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec30(output_dim,MTT_dim,SS_dim &
                   ,met,pars &
