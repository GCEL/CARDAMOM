...
! Subroutine to allow direct interface between DALEC.A1.C2.D2.F2.H2.P4.R2.011 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec11(output_dim,MTT_dim,SS_dim &
                   ,met,pars &
...
!endif
     ...
     out_var1(i,1:nodays,77) = DIAGS(1:nodays,21)       ! NCCE return (gC/gC/m2/day)
