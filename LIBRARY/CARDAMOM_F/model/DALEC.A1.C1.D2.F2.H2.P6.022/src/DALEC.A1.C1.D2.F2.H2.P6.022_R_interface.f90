...
! Subroutine to allow direct interface between DALEC.A1.C1.D2.F2.H2.P6 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec22(output_dim,MTT_dim,SS_dim &
                   ,met,pars &
