...
setwd("/exports/csce/datastore/geos/groups/gcel/EOCIS/DALEC_GRASS/migration/CARDAMOM/")
...
username="szhu4" # put your Edinburgh uun here
...
Csom_source="SoilGrids_v2" # "SoilGrids" or "SoilGrids_v2" or "HWSD" or "site_specific
